...
const navItems = [
  ...
  { href: "/applications", label: "Applications", icon: CalendarDays },
  { href: "/tenants", label: "Tenants", icon: Users },
  { href: "/leases", label: "Leases", icon: FileText },
  { href: "/payments", label: "Payments", icon: CreditCard },
  { href: "/maintenance", label: "Maintenance", icon: Wrench },
  { href: "/spaces", label: "Public Portal", icon: Store },
...
export function Sidebar() {
  ...
  useEffect(() => {
    setMounted(true);
    const storedUser = localStorage.getItem("rems-demo-user");
    if (storedUser) {
      try {
        setCurrentUser(JSON.parse(storedUser) as DemoUser);
      } catch {
        localStorage.removeItem("rems-demo-user");
      }
    }
  }, []);
